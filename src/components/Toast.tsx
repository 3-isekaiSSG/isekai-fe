...
export default function Toast({
  ...
  return (
    <div
      className={`
      fixed z-[1500] min-h-12 w-full flex items-center justify-center left-0
      ...
      `}
    >
      <div className="bg-[color:var(--m-colors-gray800)] opacity-80 w-[90%] h-full flex items-center justify-center rounded-[10px] py-3">
        <p
